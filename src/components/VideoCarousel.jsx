                ...
                <div className=' flex-center py-5 px-7 bg-gray-300 backdrop-blur rounded-full'>
                    {videoRef.current.map((_, i) => (
                        <span key={i}
                            ...
                            className=' mx-2 w-3 h-3 bg-gray-200 rounded-lg relative cursor-pointer'
                        >
                            <span key={i} className=' absolute h-full w-full rounded-full'
                ...
                <button className=' control-btn'>
                    <img
                        src={isLastVideo ? replayImg :
                            !isPlaying ? playImg : pauseImg} alt={isLastVideo ? 'replay' : !isPlaying ? 'play' : 'pause'}
